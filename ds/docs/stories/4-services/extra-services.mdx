...
<DocsColumns>
  ...
  <div>
    ...
    <DocsCodeBlock
      code={`
        import { A11yService } from '@ds/core'
        //
    ...
    <DocsCodeBlock
      code={`
        import { isA11yModeDefault, isA11yModeKeyboard, isA11yModePointer, ATTR_KEY__A11Y_MODE } from '@ds/core'
        //
        console.log(isA11yModeDefault(), isA11yModeKeyboard(), isA11yModePointer(), ATTR_KEY__A11Y_MODE)
      `}
    />
  </div>
</DocsColumns>
...
- Use utility functions `isA11yModeDefault()`, `isA11yModeKeyboard()` or `isA11yModePointer()` for mode checking outside React components
...
<DocsColumns>
  ...
  <div>
    ...
    <DocsCodeBlock
      code={`
        import { ViewportService } from '@ds/core'
        //
