...
import { type ReactNode, type RefObject, useCallback, useId, useMemo } from 'react'
...
export const Chart = (props: Props) => {
  ...
  const getQueryClass = (index: number | string) => {
    ...
    return {
      bar: isMatch ? (lcQueries.length ? 'stroke-color-border-highlight!' : undefined) : 'opacity-30',
